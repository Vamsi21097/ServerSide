...
function method(index){
  ...
  request.onload = () =>{
    const data = JSON.parse(request.responseText);
    let string = "";
    string += "<h3 id=form-isbn class=\"form-control\">ISBN &ensp;&emsp;&emsp;- &emsp;"+data.isbn
    string += "<h3 class=\"form-control\">Title &ensp;&emsp;&nbsp;- &emsp;"+data.titles[0]+"</h3>"
    string += "<h3 class=\"form-control\">Author &ensp;&emsp;- &emsp;"+data.authors[0]+"</h3>";
    string += "<h3 class=\"form-control\">Year &ensp;&emsp;&emsp;- &nbsp;"+data.years[0]+"</h3>";
